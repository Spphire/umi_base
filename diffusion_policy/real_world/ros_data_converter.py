...
from diffusion_policy.common.space_utils import ros_pose_to_6d_pose
from diffusion_policy.common.data_models import SensorMessage
...
class ROS2DataConverter:
    ...
    def __init__(self,
                 ...
                 # TODO: remove all tactile-related variables
