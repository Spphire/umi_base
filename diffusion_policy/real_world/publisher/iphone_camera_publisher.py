...
class IPhoneCameraPublisher(Node):
    ...
    def launch_debug_publisher(self, 
                               zarr_path: str = "/home/fangyuan/Documents/umi_base/.cache/cloud_pick_and_place_image_dataset/ec406a9f992d8294/replay_buffer.zarr"):
        """
        ...
        for i in range(len(imgs)):
            ...
            if img is not None:
                self.publish_color_image(img, camera_timestamp=self.get_clock().now().to_msg())
                precise_sleep(max(0., 1. / self.fps))
