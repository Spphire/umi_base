...
from diffusion_policy.common.data_models import (SensorMessage, SensorMessageList)
...
class DataRecorder(Node):
    ...
    def __init__(self,
        ...
        self.ts = ApproximateTimeSynchronizer(self.subscribers, queue_size=6, slop=0.1,
