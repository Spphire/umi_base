...
from diffusion_policy.common.space_utils import (pose_6d_to_pose_7d, pose_6d_to_4x4matrix, matrix4x4_to_pose_6d)
...
class RealRobotEnvironment(Node):
    ...
    def __init__(self,
        ...
        self.ts = ApproximateTimeSynchronizer(self.subscribers, queue_size=40, slop=0.5,
