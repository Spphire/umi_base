...
from diffusion_policy.real_world.teleoperation.teleop_server import TeleopServer
from diffusion_policy.real_world.publisher.bimanual_robot_publisher import BimanualRobotPublisher
from diffusion_policy.real_world.robot.bimanual_flexiv_server import BimanualFlexivServer
import hydra
...
@hydra.main(
    config_path="diffusion_policy/config", config_name="real_world_env", version_base="1.3"
)
